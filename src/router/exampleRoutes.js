import ExamplesHome from '@/views/examples/home.vue'
...
import Example3 from '@/views/examples/example3.vue'
import Example4p1 from '@/views/examples/example4p1.vue'
import Example4p2 from '@/views/examples/example4p2.vue'
import Example4p3 from '@/views/examples/example4p3.vue'
import Example5 from '@/views/examples/examples/example5.vue'
