<template>
  <main class="flex-1 bg-secondary-100">
    <BasePageHeading>{{ $t('edit_person') }}</BasePageHeading>
    ...
    <section class="p-8">
      <div class="lg:grid lg:grid-cols-12 lg:gap-x-5">
          ...
          <nav class="space-y-1">
            ...
            >
              <BaseIconOutlined
                ...
                name="identification"
              />
              <span class="truncate">{{ $t('contact_info') }}</span>
            </a>
        ...
        <div class="space-y-6 sm:px-6 lg:px-0 lg:col-span-9">
          <form v-if="false" id="profile" action="#" method="POST">
          ...
          <form id="contact-info" action="#" method="POST">
            <div class="shadow sm:rounded-md sm:overflow-hidden">
              <div class="px-4 py-6 space-y-6 bg-white sm:p-6">
                <div>
                  <h3 class="text-lg font-medium leading-6 text-gray-900">
          ...
          <form id="family-info" action="#" method="POST">
            <div class="shadow sm:rounded-md sm:overflow-hidden">
              <div class="px-4 py-6 space-y-6 bg-white sm:p-6">
                <div>
                  <h3 class="text-lg font-medium leading-6 text-gray-900">
              ...
              <div class="px-4 py-6 space-y-6 bg-white sm:p-6">
                ...
                <OField
                  label-class="block text-sm font-medium text-gray-700"
                  :label="$t('address_access_instructions')"
                >
                  <OInput
                    maxlength="200"
                    type="textarea"
                    input-class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                    :placeholder="$t('address_access_placeholder')"
                  />
                </OField>
              </div>
          ...
          <form id="volunteer-profile" action="#" method="POST">
            <div class="shadow sm:rounded-md sm:overflow-hidden">
              ...
              <div class="px-4 py-6 space-y-6 bg-white sm:p-6">
                ...
                <OField
                  label-class="block text-sm font-medium text-gray-700"
                  :label="$t('affiliate_training_completed')"
                >
                  <ODatepicker
                    icon="calendar"
                    input-class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                ...
                <OField
                  label-class="block text-sm font-medium text-gray-700"
                  :label="$t('agency_training_completed')"
                >
                  <ODatepicker
                    icon="calendar"
                    input-class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                ...
                <OField
                  label-class="block text-sm font-medium text-gray-700"
                  :label="$t('church_training_completed')"
                >
                  <ODatepicker
                    icon="calendar"
                    input-class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                ...
                <OField
                  label-class="block text-sm font-medium text-gray-700"
                  :label="$t('agency_background_check_completed')"
                >
                  <ODatepicker
                    icon="calendar"
                    input-class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                ...
                <OField
                  label-class="block text-sm font-medium text-gray-700"
                  :label="$t('church_background_check_completed')"
                >
                  <ODatepicker
                    icon="calendar"
                    input-class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                ...
                <OField
                  label-class="block text-sm font-medium text-gray-700"
                  :label="$t('fingerprints_completed')"
                >
                  <ODatepicker
                    icon="calendar"
                    input-class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
          ...
          <form id="notes" action="#" method="POST">
            <div class="shadow sm:rounded-md sm:overflow-hidden">
              ...
              <div class="px-4 py-6 space-y-6 bg-white sm:p-6">
                ...
                <OField
                  label-class="block text-sm font-medium text-gray-700"
                  :label="$t('who_can_view_this_note')"
                >
                  <OSelect :placeholder="$t('select_an_agency')" expanded>
                    <option value="1">Staff Only</option>
                    <option value="2">Option 2</option>
